...
// removal set. The owner cannot kick themselves — reuses leave's `ownerCannotLeave` reason
// (001 §12.9 is explicit about this, even though the action is "kick" not "leave").
