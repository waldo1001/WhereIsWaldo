...
| Backend | 🔵 **B1–B4, B6 merged** (family/device/http, locations §5.1/§5.2, invites/members §3.2–3.6, locate+FCM §6/§8, history §5.3/§7.4 + Azurite integration). B5 (geofences) in progress. 265 tests, mutation 99.53%. |
...
| B5 | Geofences §7 (config ETag flow, events, flag-filtered fan-out) | B2, B4 | in-progress |
